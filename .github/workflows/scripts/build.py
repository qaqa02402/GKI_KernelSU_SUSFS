...
DEFAULT_BUILD_MATRIX = {
    ...
    "android13-5.10": [
        {"sub_level": "136", "os_patch_level": "2023-01"},
        {"sub_level": "198", "os_patch_level": "2024-01"},
        {"sub_level": "209", "os_patch_level": "2024-05"},
        {"sub_level": "236", "os_patch_level": "2025-05"},
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ksu-driver-version", default=None)
...
def create_build_config(args: argparse.Namespace) -> BuildConfig:
    return BuildConfig(
        ...
        kernelsu_driver_version=args.ksu_driver_version,
